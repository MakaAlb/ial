...
void List_Dispose( List *list ) {
  ...
  while(list->firstElement != NULL){
    ...
    list->firstElement = tmpPtr->nextElement;
    free(tmpPtr);
  }
  list->activeElement = NULL;
}
 ...
 */
void List_InsertFirst( List *list, void* data ) {
  //	solved = FALSE; /* V případě řešení, smažte tento řádek! */
  ListElementPtr tmpPtr;
  tmpPtr = malloc(sizeof(struct ListElement));
  if (tmpPtr == NULL) List_Error();
  else {
    tmpPtr->data = data;
    tmpPtr->nextElement = list->firstElement;
 ...
 */
void List_GetFirst( List *list, void** dataPtr ) {
  if(list->firstElement == NULL) List_Error();
...
void List_DeleteFirst( List *list ) {
  ListElementPtr tmpPtr = list->firstElement;
...
void List_DeleteAfter( List *list ) {
  ...
  if (list->activeElement != NULL){
    ...
    if(tmpPtr != NULL) list->activeElement->nextElement = tmpPtr->nextElement;
    free(tmpPtr);
  }
 ...
 */
void List_InsertAfter( List *list, void* data ) {
  ListElementPtr tmpPtr;
  tmpPtr = malloc(sizeof(struct ListElement));
  if (tmpPtr == NULL) List_Error();
  else {
    tmpPtr->data = data;
    tmpPtr->nextElement = list->activeElement->nextElement;
    list->activeElement->nextElement = tmpPtr;
  }
}
 ...
 * @param dataPtr Ukazatel na cílovou proměnnou
 */
void List_GetValue( List *list, void* *dataPtr ) {
  if(list->activeElement == NULL) List_Error();
 ...
 */
void List_SetValue( List *list, void* data ) {
